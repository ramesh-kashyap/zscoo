                                    ...
                                    <div class="verify-section-main align-items-stretch h-100">
                                        <div class="amigo-box-main">
                                            <div class="plus-box-text-main">
                                                <h4 class="amigo-pluse-text">{{siteName()}} @lang('Plus')</h4>
                                                <h4 class="unlock">@lang('Unlock GSTAIQ premium to unlock all features.')</h4>
                                               
                                                <button class="upgrades-btn-main"> <h6>@lang('Total Assets') </h6>{{number_format(Auth::user()->available_balance(),2)}} USDT </button>  
                                        ...
                                        <div data-v-524186f8="" class="box invite">
                                            <a href="{{ route('user.share') }}">
                                                <div data-v-524186f8="" class="box-top">
                                                    ...
                                                    <p data-v-524186f8="">@lang('Share GSTAIG Quantitative Bonus')</p>
                                                </div>
                                            </a>
