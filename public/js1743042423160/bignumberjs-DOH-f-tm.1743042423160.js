...
function we(O) {
    ...
    function h(e, r) {
        ...
        if (r == null) {
            ...
            if (u = String(e), n = typeof e == "number") {
                ...
                if (o.s = 1 / e < 0 ? (u = u.slice(1), -1) : 1, h.DEBUG && u.replace(/^0\.0*|\./, "").length > 15) throw Error(pe + e)
        ...
        if (u = u.slice(c, ++f)) {
            if (f -= c, n && h.DEBUG && f > 15 && (e > ae || e !== y(e))) throw Error(pe + o.s * e);
    ...
    h.clone = we, h.ROUND_UP = 0, h.ROUND_DOWN = 1, h.ROUND_CEIL = 2, h.ROUND_FLOOR = 3, h.ROUND_HALF_UP = 4, h.ROUND_HALF_DOWN = 5, h.ROUND_HALF_EVEN = 6, h.ROUND_HALF_CEIL = 7, h.ROUND_HALF_FLOOR = 8, h.EUCLID = 9, h.config = h.set = function(e) {
        ...
        if (e != null)
            if (typeof e == "object") {
                if (e.hasOwnProperty(r = "DECIMAL_PLACES") && (i = e[r], v(i, 0, D, r), x = i), e.hasOwnProperty(r = "ROUNDING_MODE") && (i = e[r], v(i, 0, 8, r), S = i), e.hasOwnProperty(r = "EXPONENTIAL_AT") && (i = e[r], i && i.pop ? (v(i[0], -D, 0, r), v(i[1], 0, D, r), C = i[0], k = i[1]) : (v(i, -D, D, r), C = -(k = i < 0 ? -i : i))), e.hasOwnProperty(r = "RANGE"))
                    if (i = e[r], i && i.pop) v(i[0], -D, -1, r), v(i[1], 1, D, r), Q = i[0], z = i[1];
                    else if (v(i, -D, D, r), i) Q = -(z = i < 0 ? -i : i);
                else throw Error(U + r + " cannot be zero: " + i);
                if (e.hasOwnProperty(r = "CRYPTO"))
                    if (i = e[r], i === !!i)
                        if (i)
                            if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) Z = i;
                            else throw Z = !i, Error(U + "crypto unavailable");
                else Z = i;
                else throw Error(U + r + " not true or false: " + i);
                ...
                if (e.hasOwnProperty(r = "ALPHABET"))
                    ...
                    else throw Error(U + r + " invalid: " + i)
        ...
        return function(i) {
            ...
            if (i == null ? i = x : v(i, 0, D), c = ce(i / N), Z)
                ...
                f = c / 7
            } else throw Z = !1, Error(U + "crypto unavailable");
            if (!Z)
        ...
        return function(s, t, l, c, n) {
            var f, u, o, a, p, w, A, B, M, m, d, P, re, se, ue, X, ee, F = s.s == t.s ? 1 : -1,
                L = s.c,
                I = t.c;
            if (!L || !L[0] || !I || !I[0]) return new h(!s.s || !t.s || (L ? I && L[0] == I[0] : !I) ? NaN : L && L[0] == 0 || !I ? F * 0 : F / 0);
            for (B = new h(F), M = B.c = [], u = s.e - t.e, F = l + u + 1, n || (n = H, u = $(s.e / N) - $(t.e / N), F = F / N | 0), o = 0; I[o] == (L[o] || 0); o++);
            if (I[o] > (L[o] || 0) && u--, F < 0) M.push(1), a = !0;
            else {
    ...
    function le(e, r, i, s) {
        ...
        if (t = e.c[0], c = e.e, r == null) f = q(e.c), f = s == 1 || s == 2 && (c <= C || c >= k) ? ne(f, c) : W(f, c, "0");
    ...
    R = function() {
        ...
        return function(l, c, n, f) {
            ...
            if (s.test(o)) l.s = isNaN(o) ? null : o < 0 ? -1 : 1;
                ...
                if (h.DEBUG) throw Error(U + "Not a" + (f ? " base " + f : "") + " number: " + c);
                l.s = null
            }
            l.c = l.e = null
        }
    ...
    return g.absoluteValue = g.abs = function() {
        ...
        var i, s, t, l = this;
        if (e != null) return v(e, 0, D), r == null ? r = S : v(r, 0, 8), G(new h(l), e + l.e + 1, r);
        ...
        if (e = new h(e), e.c && !e.isInteger()) throw Error(U + "Exponent not an integer: " + V(e));
        ...
        var i, s, t, l, c, n, f, u, o, a, p, w, A, B, M, m = this,
            d = m.c,
            P = (e = new h(e, r)).c;
        if (!d || !P || !d[0] || !P[0]) return !m.s || !e.s || d && !d[0] && !P || P && !P[0] && !d ? e.c = e.e = e.s = null : (e.s *= m.s, !d || !P ? e.c = e.e = null : (e.c = [0], e.e = 0)), e;
        for (s = $(m.e / N) + $(e.e / N), e.s *= m.s, f = d.length, a = P.length, f < a && (A = d, d = P, P = A, t = f, f = a, a = t), t = f + a, A = []; t--; A.push(0));
        for (B = H, M = J, t = a; --t >= 0;) {
            for (i = 0, p = P[t] % M, w = P[t] / M | 0, c = f, l = t + c; l > t;) u = d[--c] % M, o = d[c] / M | 0, n = w * u + o * p, u = p * u + n % M * M + A[l] + i, i = (u / B | 0) + (n / M | 0) + w * o, A[l--] = u % B;
            A[l] = i
        }
        ...
        var i, s, t, l = this;
        if (e != null && e !== !!e) return v(e, 1, D), r == null ? r = S : v(r, 0, 8), G(new h(l), e, r);
        if (!(i = l.c)) return null;
        ...
        else if (typeof i != "object") throw Error(U + "Argument not an object: " + i);
        ...
        var r, i, s, t, l, c, n, f, u, o, a, p, w = this,
            A = w.c;
        if (e != null && (n = new h(e), !n.isInteger() && (n.c || n.s !== 1) || n.lt(T))) throw Error(U + "Argument " + (n.isInteger() ? "out of range: " : "not an integer: ") + V(n));
        if (!A) return new h(w);
        for (r = new h(T), u = i = new h(T), s = f = new h(T), p = q(A), l = r.e = p.length - w.e - 1, r.c[0] = he[(c = l % N) < 0 ? N + c : c], e = !e || n.comparedTo(r) > 0 ? l > 0 ? r : u : n, c = z, z = 1 / 0, n = new h(p), f.c[0] = 0; o = E(n, r, 0, 1), t = i.plus(o.times(s)), t.comparedTo(e) != 1;) i = s, s = t, u = f.plus(o.times(t = u)), f = t, r = n.minus(o.times(t = r)), n = t;
...
function j(O, E) {
    ...
    for (S = (C = g.length) < (k = T.length) ? C : k, x = 0; x < S; x++)
        if (g[x] != T[x]) return g[x] > T[x] ^ _ ? 1 : -1;
    return C == k ? 0 : C > k ^ _ ? 1 : -1
}

function v(O, E, _, R) {
    if (O < E || O > _ || O !== y(O)) throw Error(U + (R || "Argument") + (typeof O == "number" ? O < E || O > _ ? " out of range: " : " not an integer: " : " not a primitive number: ") + String(O))
}
